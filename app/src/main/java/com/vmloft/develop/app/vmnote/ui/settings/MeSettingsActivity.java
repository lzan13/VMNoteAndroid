 ...
 * 个人信息设置界面
 */
public class MeSettingsActivity extends AppActivity {
    ...
    protected void initData() {
        setTopTitle(R.string.settings_me);
    ...
    @OnClick({
        R.id.me_avatar_line, R.id.me_nickname_line, R.id.me_signature_line, R.id.me_gender_line, R.id.me_birthday,
